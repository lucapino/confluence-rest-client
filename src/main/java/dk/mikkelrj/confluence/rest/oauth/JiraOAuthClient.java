...
public class JiraOAuthClient {
    ...
    private static final String PATH_OAUTH_AUTHORIZE = "/plugins/servlet/oauth/authorize";
    
	private final String baseUrl;
    private final JiraOAuthTokenFactory oAuthGetAccessTokenFactory;
    private final String authorizationUrl;

    public JiraOAuthClient(OAuthProperties properties) throws Exception {
        this.baseUrl = properties.get(OAuthProperties.BASE_URL);
        this.oAuthGetAccessTokenFactory = new JiraOAuthTokenFactory(this.baseUrl);
        this.authorizationUrl = baseUrl + PATH_OAUTH_AUTHORIZE;
    }
